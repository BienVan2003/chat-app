...
export default function SignIn() {
  ...
  const handleLogin = async () => {
    if(!emailRef.current || !passwordRef.current){
      Alert.alert('Đăng Nhập', 'Vui lòng điền vào tất cả các trường!');
      return;
    }
      ...
      <View style={{ paddingTop: hp(8), paddingHorizontal: wp(5) }} className="flex-1 gap-12">
        ...
        <View className="gap-10">
          ...
          <View className="gap-4">
            ...
            <View className="flex-row justify-center">
              <Text style={{ fontSize: hp(1.8) }} className="font-semibold text-neutral-500">Bạn chưa có tài khoản?</Text>
              <Pressable onPress={() => router.push('signUp')}>
                <Text style={{ fontSize: hp(1.8) }} className="font-bold text-indigo-500"> Đăng Ký Ngay</Text>
              </Pressable>
            </View>
          </View>
        </View>
